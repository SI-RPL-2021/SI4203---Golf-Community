...
<div class="container">
    ...
    $proses = '/digitalwallet/transfer_proses';
    @endphp
	

    <hr>
    <h3 class="text-center">Transfer Digital Wallet</h3>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{$proses}}" method="post">
                        {{ csrf_field() }}
                        <hr>
                        Masukan Nomor Rekening Mandiri
                        <input type="text" name="catatan" class="form-control" required="required">
                        <input type="hidden" name="id_user" value="{{Auth::user()->id}}">
                        Masukan nominal Transfer 
                        <input type="number" name="saldo" class="form-control" required="required"> <br/>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{$proses}}" method="post">
                        ...
                        Masukan Nomor Rekening BCA
                        <input type="text" name="catatan" class="form-control" required="required">
                        <input type="hidden" name="id_user" value="{{Auth::user()->id}}">
                        Masukan nominal Transfer <input type="number" name="saldo" class="form-control" required="required"> <br/>
        ...
        <div class="modal fade" id="bsi" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="{{ URL::asset('images/bsi.png') }}" height="40px" alt="">
                    <br><br>
                    Transfer e-money Mandiri dari Bank Syariah Indonesia bisa kita akses dari dua menu yaitu menu Top-up eWallet dan Beli. Keduanya sama saja, jadi tidak perlu bingung harus pilih menu yang mana.
                    <hr>
                    <form action="{{$proses}}" method="post">
                        {{ csrf_field() }}
                        
                        Masukan Nomor Rekening BSI
                        <input type="text" name="catatan" class="form-control" required="required">
                        <input type="hidden" name="id_user" value="{{Auth::user()->id}}">
                        Masukan nominal Transfer <input type="number" name="saldo" class="form-control" required="required"> <br/>
