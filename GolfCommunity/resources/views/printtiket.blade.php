        ...
        <div class="ticket">
          ...
          <div class="content">
            ...
            <div class="sub-content">
              ...
              <span class="gate">TANGGAL BELI<br><span>{{$p->tgl_beli}}</span></span>
              <span class="boardingtime">KUOTA<br><span>{{$p->jumlah}} ORANG</span></span>
                  
               <span class="flight flightslip">KUOTA<br><span>{{$p->jumlah}} ORANG</span></span>
                <span class="seat seatslip">HARGA<br><span>{{$p->total_harga}}</span></span>
               <span class="name nameslip">KODE TIKET<br><span class="text-uppercase">{{$p->kode}}</span></span>
            </div>
          </div>
