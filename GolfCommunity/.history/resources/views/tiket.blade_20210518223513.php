    ...
    <h2 class="mt-4 mb-4 text-center">Beli Tiket Pertandingan</h2>
      ...
      <div class="card mb-3">
        <div class="row no-gutters">
          <div class="col-md-3">
            <img src="{{ URL::asset('images/upload/') }}/{{ $p->gambar }}" class="card-img img-fluid" style="object-fit: cover; max-height: 120px;" alt="{{$p->nama}}">
          </div>
          <div class="col-md-6">
            <div class="card-body">
          ...
          <div class="col-md-3 d-flex justify-content-end">
            <a href="#" class="d-inline-flex align-self-center btn btn-success m-2 px-8">Beli</a>
          </div>
        </div>
      </div>
