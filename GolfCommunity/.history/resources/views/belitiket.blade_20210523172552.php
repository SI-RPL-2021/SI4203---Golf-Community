        ...
        <div class="col-md-6">
            ...
            <form name="buatpertandingan" id="buatpertandingan" method="post" enctype="multipart/form-data" action="{{url('/pertandingan/form-pertandingan')}}">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="number" min="1" name="banyak_tiket" id="inputbanyak_tiket" value="1" class="form-control">
                </div>
                <div class="form-group mb-2">
                    <label for="inputkuota_pemain">Total Harga</label>
                    <input type="text" name="total_harga" id="inputtotal_harga" class="form-control">
                </div>
