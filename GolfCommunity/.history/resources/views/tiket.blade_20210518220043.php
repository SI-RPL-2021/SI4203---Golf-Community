...
<div class="container">
  ...
  <div class="card mb-3">
    <div class="row no-gutters">
      <div class="col-md-3">
        <img src="https://picsum.photos/seed/picsum/200/300" class="card-img img-fluid" style="object-fit: cover; max-height: 200px;">
      </div>
      <div class="col-md-9">
        <div class="card-body">
          ...
          <div class="card-text d-block"><a href="#" class="btn btn-success float-right">Beli</a></div>
        </div>
      </div>
    </div>
  </div>
