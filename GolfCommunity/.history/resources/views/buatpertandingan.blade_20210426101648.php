    ...
    <div class="row row-cols-1 row-cols-md-2 g-4 my-4">
        <form name="buatpertandingan" id="buatpertandingan" method="post" action="{{url('/pertandingan/form-pertandingan')}}">
            ...
            <div class="form-group">
                ...
                <input type="number" name="harga_tiket" id="inputharga_tiket" min="0">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="jumlah_pemain" id="inputjumlah_pemain" min="1">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="kuota_pemain" id="inputkuota_pemain">
            </div>
